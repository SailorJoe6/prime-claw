# phase1-brain.Dockerfile — prime-claw Phase 1 Slice 4 (U2) brain-stack image.
#
...
#   docker build -f docker/phase1-brain.Dockerfile -t prime-claw-brain:0.1.0 docker
...
# Inputs copied into docker/phase1-brain/gbrain/ by scripts/apply-phase1-brain.sh
# from the operator's local zbrain checkout.
COPY phase1-brain/gbrain /opt/gbrain
WORKDIR /opt/gbrain
